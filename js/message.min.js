...
!(function (o, t) {
  ...
  function o(o, t) {
    ...
    for (var n in o) {
      var s = o[n]
      "className" == n
        ? ((n = "class"), e.setAttribute(n, s))
        : "_" == n[0] && e.addEventListener(n.slice(1), s)
    }
    if ("string" == typeof t) e.innerHTML = t
    else if ("object" == _typeof(t) && t.tagName) e.appendChild(t)
    else if (t)
  ...
  function r(o, t) {
    ...
    for (var s = 0; s < o.length; s++) {
      var i = o[s]
      void 0 !== i &&
        ("string" == typeof i || "object" == _typeof(i)
          ? (e.msg = i)
          : "boolean" == typeof i
          ? (e.showClose = i)
          : "function" == typeof i
            ...
            o(
              {
                className: "coco-msg-wait ".concat(
                  g ? "coco-msg-pointer" : "coco-msg-wait-hidden"
                ),
                _click: function () {
                  f(h, d)
                },
      ...
      setTimeout(function () {
        if (o) {
          for (var t = !1, e = 0; e < m.children.length; e++)
            m.children[e] === o && (t = !0)
          t && d(o), (o = null), m.children.length || (t && d(m))
        }
      }, 300))
  }
