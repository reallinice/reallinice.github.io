      ...
      <div class="memos-editor-tools pt-3">
        <div class="d-flex">
          <div class="button outline action-btn tag-btn mr-2">
            <img src="https://www.lixiangqian.com/img/memos/memos_tag.svg">
          </div>
          <div class="button outline action-btn image-btn mr-2" onclick="this.lastElementChild.click()">
            <img src="https://www.lixiangqian.com/img/memos/memos_img_up.svg">
            <input class="memos-upload-image-input d-none" type="file" accept="image/*">
          </div>
          <div class="button outline p-2 action-btn todo-btn mr-2">
            <img src="https://www.lixiangqian.com/img/memos/memos_list.svg">
          </div>
          <div class="button outline action-btn code-btn mr-2">
            <img src="https://www.lixiangqian.com/img/memos/memos_code.svg">
          </div>
          <div class="button outline action-btn mr-2 link-btn">
            <img src="https://www.lixiangqian.com/img/memos/memos_link.svg">
          </div>
          <div class="button outline action-btn mr-2 link-img">
          <img src="https://www.lixiangqian.com/img/memos/memos_img_quote.svg">
        </div>
          <div class="button outline action-btn p-2 random-btn">
            <img src="https://www.lixiangqian.com/img/memos/memos_random_n.svg">
          </div>
          <div class="button outline action-btn switchUser-btn">
            <img src="https://www.lixiangqian.com/img/memos/memos_user.svg">
          </div>
        </div>
...
function getEditIcon() {
  ...
  todoBtn.addEventListener("click", function () {
    ...
    if (memosPath && memosOpenId) {
      ...
      memosTextarea.setSelectionRange(
        caretPos + memoTodo.length,
        caretPos + memoTodo.length
      ) // 将光标定位到 `[]` 之后
      memosTextarea.focus()
    }
  ...
  codeBtn.addEventListener("click", function () {
    ...
    if (memosPath && memosOpenId) {
      ...
      const caretPos =
        lastBacktickIndex !== -1 ? lastBacktickIndex : textareaValue.length // 将光标定位到最后一个 ``` 的位置
  ...
  linkBtn.addEventListener("click", function () {
    ...
    if (memosPath && memosOpenId) {
      ...
      memosTextarea.value =
        memosTextarea.value.substring(0, memosTextarea.selectionStart) +
        memoLink +
        memosTextarea.value.substring(memosTextarea.selectionEnd)
